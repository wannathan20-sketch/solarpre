...
def main():
    parser = argparse.ArgumentParser(description="Backtest CAISO load/renewable generation forecasts.")
    parser.add_argument("--input", required=True, help="CAISO CSV generated by data_sources/caiso_oasis.py.")
    ...
    parser.add_argument("--output", default=str(BASE_DIR / "data" / "caiso_predictions.csv"))
    parser.add_argument("--metrics-output", default=str(BASE_DIR / "data" / "caiso_backtest_metrics.json"))
